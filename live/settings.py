...
class LiveSettings:
    ...
    max_spread_pips_eth:           float = 100.0
    max_spread_pips_btc:           float = 400.0
    ...
    def max_spread_pips(self, symbol: str) -> float:
        ...
        if symbol == "ETHUSD": return self.max_spread_pips_eth
        if symbol == "BTCUSD": return self.max_spread_pips_btc
        if symbol in ("US500", "US100", "US30", "UK100", "GER40", "AUS200", "JP225"):
            return 20.0  # Safe default max spread for indices
...
def load_settings() -> LiveSettings:
    ...
    s = LiveSettings(
        ...
        usdjpy_candidates = _getlist("USDJPY_CANDIDATES", "USDJPY,USDJPYm,USDJPY."),
        ethusd_candidates = _getlist("ETHUSD_CANDIDATES", "ETHUSD,ETHUSDm,ETHUSD."),
        btcusd_candidates = _getlist("BTCUSD_CANDIDATES", "BTCUSD,BTCUSDm,BTCUSD.,XBTUSD"),
        us500_candidates  = _getlist("US500_CANDIDATES",  "US500Cash,US500m,US500."),
        us100_candidates  = _getlist("US100_CANDIDATES",  "US100Cash,US100m,US100."),
        us30_candidates   = _getlist("US30_CANDIDATES",   "US30Cash,US30m,US30."),
        uk100_candidates  = _getlist("UK100_CANDIDATES",  "UK100Cash,UK100m,UK100."),
        ger40_candidates  = _getlist("GER40_CANDIDATES",  "GER40Cash,GER40m,GER40."),
        aus200_candidates = _getlist("AUS200_CANDIDATES", "AUS200Cash,AUS200m,AUS200."),
        jp225_candidates  = _getlist("JP225_CANDIDATES",  "JP225Cash,JN225m,JN225."),

        # Active
        active_symbols = _getlist("ACTIVE_SYMBOLS", "GOLD,SILVER,EURUSD,GBPUSD,USDJPY,ETHUSD,BTCUSD"),
